...
export function filterCustomerOrder(businessEmailData,passwordData){
    ...
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.contains('Orders').click()
    cy.get('#vs12__combobox > .vs__selected-options > .vs__search').click()
...
export function filterCustomerFacebookName(){
    ...
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__option-6').click()
    cy.get('#vs12__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs12__option-2').click()
...
export function filterCustomerPhoneNumber(){
    ...
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__option-8').click()
    cy.get('#vs12__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs12__option-0').click()
...
export function filterCustomerCities(){
    ...
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__option-11').click()
    cy.get('#vs12__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs12__option-0').click()
    cy.get('#vs12__combobox').click()
    //cy.get('#vs13__combobox').click()
...
export function filterCustomerChannels(){
    ...
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs11__option-15').click()
    cy.get('#vs12__combobox > .vs__selected-options > .vs__search').click()
    cy.get('#vs12__combobox > .vs__selected-options')
    cy.get('#vs12__option-0').click()
    //cy.get('#vs22__combobox').click()
